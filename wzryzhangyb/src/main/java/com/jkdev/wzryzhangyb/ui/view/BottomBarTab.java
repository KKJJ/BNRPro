...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_unselect));
        ...
        mTvTitle.setTextColor(getResources().getColorStateList(R.color.tab_text_color)); // 字体
//        mTvTitle.setBackgroundResource(R.drawable.main_tab_text_selector); // 背景
...
//        mTvUnreadCount.setBackgroundResource(R.drawable.main_tab_text_selector);
