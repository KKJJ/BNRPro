...
public class ThirdTab1Fragment extends SupportFragment {

    private static final String TAG = "--ThirdTab1Fragment";
    ...
    private void initData() {
        mNetworkClient.getSquareHotList(new Callback<String>() {
